...
public final class AetherCrucibleMachines {
    ...
    public static final MachineDefinition AETHER_CRUCIBLE = REGISTRATE
            ...
            .recipeType(AETHER_CRUCIBLE)
            .recipeModifiers(
                    GTRecipeModifiers.PARALLEL_HATCH,
                    GTRecipeModifiers.OC_NON_PERFECT,
                    AetherCrucibleMachine::recipeModifier)
            .appearanceBlock(AETHER_CASING)
            ...
            .pattern(definition -> MultiblockPatternBuilder
                    ...
                    .where('C', Predicates.blocks(AETHER_CASING.get())
                    ...
                    .build())
            .workableCasingModel(
                    "phoenixcore:block/casings/multiblock/aether_casing",
                    "phoenixcore:block/multiblock/aether_crucible")
            .register();

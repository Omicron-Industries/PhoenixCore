...
public record TerrainProfile(
    ...
    public static class Builder {
        ...
        public Builder seaLevel(int y)          { this.seaLevel = y;          return this; }
        public Builder baseY(double y)          { this.baseY = y;             return this; }
        public Builder amplitude(double amp)    { this.amplitude = amp;       return this; }
        public Builder frequency(double freq)   { this.frequency = freq;      return this; }
        public Builder octaves(int n)           { this.octaves = n;           return this; }
        public Builder caves(boolean b)         { this.caves = b;             return this; }
        public Builder volumetric(boolean b)    { this.volumetric = b;        return this; }
        ...
        public TerrainProfile build() {
            ...
            return new TerrainProfile(name, seed, minY, maxY, seaLevel, baseY, amplitude, frequency, octaves, caves, volumetric, terrain);
        }
    }
}

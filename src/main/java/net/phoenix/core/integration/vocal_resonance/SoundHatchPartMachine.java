...
import com.gregtechceu.gtceu.api.machine.multiblock.part.TieredPartMachine; // Changed from TieredIOPartMachine
...
public class SoundHatchPartMachine extends TieredPartMachine {
    protected static final ManagedFieldHolder MANAGED_FIELD_HOLDER =
            new ManagedFieldHolder(SoundHatchPartMachine.class, TieredPartMachine.MANAGED_FIELD_HOLDER);
    ...
    public Widget createUIWidget() {
        ...
        group.addWidget(new LabelWidget(10, 30, "§7Hardware Tier: §f" + com.gregtechceu.gtceu.api.GTValues.VNF[getTier()]));

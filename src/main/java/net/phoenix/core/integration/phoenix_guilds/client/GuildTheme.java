...
public class GuildTheme {
    ...
    public static class ThemeColor {
        ...
        public ThemeColor()            { this.hex = "FFFFFFFF"; }
        ...
        public int getColor() {
            ...
            if (cached == null) {
                try { cached = (int) Long.parseUnsignedLong(clean, 16); }
                catch (Exception e) { cached = 0xFFFFFFFF; }
            }
            return cached;
        }

        public String getHex() { return hex; }
        public void set(String h) { this.hex = h; this.cached = null; }
    }
    ...
    public static void setCurrent(String name) {
        ...
        if (t != null) { active = t; activeName = name; }
    }
    ...
    public static boolean deleteCustom(String name) {
        ...
        if (name.equals(activeName)) { activeName = "DARK"; active = REGISTRY.get("DARK"); }
        saveAll();
        return true;
    }
    ...
    public static void loadThemes() {
        ...
        REGISTRY.put("DARK",     new GuildTheme("BE050510", "FF0C0C1A", "FF060614", "FF202048", "FF4422AA", "FF2277BB", "FFDDDDFF", "FF7777AA", "FF383858"));
        REGISTRY.put("OCEAN",    new GuildTheme("BE020810", "FF091520", "FF040C18", "FF1A2E44", "FF1177CC", "FF22AADD", "FFCCE8FF", "FF6688AA", "FF263A52"));
        REGISTRY.put("CRIMSON",  new GuildTheme("BE100508", "FF1A0C0E", "FF0E0608", "FF3A1820", "FFAA1133", "FFCC3355", "FFFFE0E4", "FF9A6070", "FF503038"));
        REGISTRY.put("PHANTOM",  new GuildTheme("BE0A0510", "FF140E1C", "FF0A0812", "FF2E2040", "FF8833CC", "FF6644AA", "FFD8CCF0", "FF7060A0", "FF3C2C5C"));
        REGISTRY.put("EMERALD",  new GuildTheme("BE041008", "FF0C1A10", "FF060E08", "FF183828", "FF22AA55", "FF33CC77", "FFCCFFDD", "FF60AA78", "FF243C2E"));
        REGISTRY.put("EMBER",    new GuildTheme("BE100806", "FF1C140A", "FF100A04", "FF382410", "FFCC6600", "FFFF9922", "FFF0E0CC", "FFA0785A", "FF604830"));

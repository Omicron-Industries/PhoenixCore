...
import net.phoenix.core.integration.phoenix_guilds.Guild;
...
import net.phoenix.core.integration.phoenix_guilds.GuildRank;
...
public class C2SGuildActionPacket {
    ...
    public enum Action {
        CREATE, INVITE, REMOVE, LEAVE, DISBAND,
        PROMOTE, DEMOTE, TRANSFER,
        SET_MOTD, SET_DESC, TOGGLE_FF, SET_HOME, HOME,
        ALLY_REQUEST, ALLY_ACCEPT, ALLY_DECLINE, ALLY_BREAK,
        GUILD_CHAT, ALLY_CHAT,
    ...
    public C2SGuildActionPacket(Action action, String arg) {
        this.action = action; this.arg = arg;
    }

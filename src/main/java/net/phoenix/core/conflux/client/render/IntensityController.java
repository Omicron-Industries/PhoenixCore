...
public final class IntensityController {
    ...
    public void onHover()            { if (state == State.AMBIENT) state = State.INTERACTION; }
    public void onHoverEnd()         { if (state == State.INTERACTION) state = State.AMBIENT; }
    public void onEvent()            { spike(); }
    ...
    public float get()       { return intensity; }
